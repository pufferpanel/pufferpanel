 ...
 * @constructor
 */
var User = function (uuid, email, username, password, suspended) {
    this.uuid = uuid;
    this.email = email;
...
/**
 * Validates if a password matches this user's password
 *
 * @param {String} testPw - The password to test
 * @returns {Boolean} - True if the password matches, otherwise false
 */
User.prototype.validatePassword = function (testPw) {
    return this.password == testPw;
};

/**
 * @private
 */
User.prototype._setEmail = function (newEmail) {
    this.email = newEmail;
};
 ...
 * @private
 */
User.prototype._setUsername = function (newUsername) {
 ...
 * @private
 */
User.prototype._setPassword = function (newPw) {
    this.password = newPw;
};
 ...
 * @private
 */
User.prototype._setSuspended = function (isSuspended) {
