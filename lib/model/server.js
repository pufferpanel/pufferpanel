 ...
 * @private
 */
Server.prototype._setName = function (newName) {
    this.name = newName;
};
 ...
 * @private
 */
Server.prototype._setOwnerUUID = function (newUuid) {
    this.owner = newUuid;
};
 ...
 * @private
 */
Server.prototype._setNodeUUID = function (newUuid) {
    this.node = newUuid;
};
 ...
 * @private
 */
Server.prototype._setSuspended = function (isSuspended) {
 ...
 * @private
 */
Server.prototype._setData = function (newData) {
    this.data = newData;
};
 ...
 * @private
 */
Server.prototype._setAddresses = function (newAddresses) {
