 ...
 * @private
 */
Node.prototype._setName = function (newName) {
    this.name = newName;
};
 ...
 * @private
 */
Node.prototype.setLocationUUID = function (newUuid) {
    this.location = newUuid;
};

/**
 * @private
 */
Node.prototype._setAddresses = function (newAddresses) {
 ...
 * @private
 */
Node.prototype._setIP = function (newIp) {
    this.ip = newIp;
};
 ...
 * @private
 */
Node.prototype._setPort = function (newPort) {
    this.port = newPort;
};
