...
PufferPanel.controllers = {
    user: new UserController(PufferPanel.collections),
    server: new ServerController(PufferPanel.collections),
    location: new LocationController(PufferPanel.collections),
    node: new NodeController(PufferPanel.collections)
};
