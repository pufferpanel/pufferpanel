...
var Routes = {
    get: {
        ...
        totp: function (request, reply) {
            ...
            // Debugging here
            Logger.warn(request.session.flash('totpError'));
    ...
    post: {
        totp: {
            generateToken: function (request, reply) {
                ...
                Users.generateTOTP(request.auth.credentials, function (err, resp) {
            ...
            verifyToken: function (request, reply) {
                ...
                Users.enableTotp(request.params.token, request.auth.credentials, function (err) {
