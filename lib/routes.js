...
//Since this module is incomplete, going to not include it for now
/*
...
//TODO: We should refractor this to be split up so it reads a lot easier
//And probably worth it to use our new API
// Base Routes
server.route([
    {
        method: 'GET',
