...
server.route([
    ...
    },
    {
        ...
        config: {
            handler: Routes.Admin.settings.postUpdateCompanyName,
            auth: {
                strategy: 'session',
                scope: 'admin'
            }
    ...
    },
    {
        ...
        config: {
            handler: Routes.Admin.settings.postGeneralSettings,
            auth: {
                strategy: 'session',
                scope: 'admin'
            }
    ...
    {
        method: 'POST',
        path: '/admin/settings/urls/updateUrlSettings',
        config: {
            handler: Routes.Admin.settings.postUpdateUrlSettings,
            auth: {
                strategy: 'session',
                scope: 'admin'
            }
