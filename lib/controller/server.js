 ...
 * @param {Uuid} ownerUUID - Owner's UUID
 * @param {Uuid} nodeUUID - Node's UUID
...
ServerController.prototype.create = function (name, ownerUUID, nodeUUID, plugin, ip, port, data) {
    ...
    var server = new Server(Uuid.generate(), name, type, [{
        ip: ip, port: port
 ...
 *
 * @param {Uuid} uuid - UUID of server
 ...
 *
 * @param {Uuid} serverUUID - Server UUID
 * @param {Uuid} userUUID - New owner UUID
 */
