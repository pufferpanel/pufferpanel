...
var UserCollection = Rfr('lib/collection/usercollection.js');
 ...
 * @param {String} newPassword - The new unhashed password
 */
UserController.prototype.changePassword = function (userUUID, newPassword) {
    var self = this;
    var pw = Bcrypt.hashSync(newPassword, 10);
 ...
 */
UserController.prototype.changeEmail = function (userUUID, newEmail) {
    var self = this;
    self._updateUser(userUUID, { email: newEmail });
};
 ...
 *
 * @param {String} userUUID - User UUID to alter
 * @param {String} newPassword - The new username
 */
UserController.prototype.changeUsername = function (userUUID, newUsername) {
    var self = this;
    self._updateUser(userUUID, { username: newUsername });
};
 ...
 *
 * @param {String} userUUID - User UUID
 * @param {Object} obj - Values to update
 * @private
 */
UserController.prototype._updateUser = function (userUUID, obj) {
    self.collection.update(userUUID, obj);
};
