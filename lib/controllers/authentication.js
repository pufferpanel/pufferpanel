...
var Joi = require('joi');
var EmailController = Rfr('lib/controllers/email.js');
var UserModel = (process.env.NODE_ENV === 'test') ? Rfr('tests/models/users.js') : Rfr('lib/models/users.js');
var ActionsModel = (process.env.NODE_ENV === 'test') ? Rfr('tests/models/actions.js') : Rfr('lib/models/actions.js');
