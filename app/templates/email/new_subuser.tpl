<html>
	...
	<body>
		...
		<p>If you already have an account please <a href="{{ MASTER_URL }}index.php">login as normal</a>, and then go to <strong>Account Settings &rarr; Server Token</strong> and input the server token below.
