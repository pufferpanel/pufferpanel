	                        ...
	                        echo "Table `acp_email_templates` created.\n";
	                             ...
	                             */
	                             $mysql->exec("INSERT INTO `acp_email_templates` (`id`, `tpl_name`, `tpl_content`) VALUES
	                                ...
	                                (9,'admin_new_ftppass','<html>\n	<head>\n		<title><%HOST_NAME%> - ftp Password Changed</title>\n	</head>\n	<body>\n		<center><h1><%HOST_NAME%> - ftp Password Changed </h1></center>\n		<p>Hello there! This email is to inform you that the ftp password for <%SERVER%> has been changed by an administrator.</p>\n		<p><strong>New Password:</strong> <%PASS%><br />\n		<p>Thanks!<br /><%HOST_NAME%></p>\n	</body>\n</html>'),
