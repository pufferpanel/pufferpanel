                        ...
                        if(isset($_POST['do_connect'])){
                            ...
                            try {
                                ...
                                $database->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                    ...
                                    $fp = fopen('../../../../src/configuration.php.dist', 'w+');
                                    fwrite($fp, "<?php
...
\$_INFO['sql_ssl_ca-cert'] = '/path/to/ca-cert.pem';");
                                    ...
                                    if(!rename('../../../../src/configuration.php.dist', '../../../../src/configuration.php')){
		...
		<div class="footer">
			<div class="col-8 nopad"><p>PufferPanel is licensed under a <a href="https://github.com/DaneEveritt/PufferPanel/blob/master/LICENSE">GPL-v3 License</a>.<br />Running Version 0.6.1 Beta distributed by <a href="http://kelp.in">Kelpin' Systems</a>.</p></div>
		</div>
	</div>
</body>
</html>