...
Congratulations! You should have PufferPanel running smoothly at this point. From here, you should move on to `setting up your first node <installing_nodes.rst>`_.