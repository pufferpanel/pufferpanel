...
use \ORM, \PufferPanel\Core\Config;
...
trait Authentication {
	...
	*/
	public static function encrypt($raw, $iv){
		...
		return openssl_encrypt($raw, 'AES-256-CBC', Config::global()->hash, false, base64_decode($iv));
	...
	*/
	public static function decrypt($encrypted, $iv, $method = 'AES-256-CBC'){
		...
		return openssl_decrypt($encrypted, $method, Config::global()->hash, 0, base64_decode($iv));
