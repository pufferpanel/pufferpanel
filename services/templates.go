...
const TemplateJson = "https://raw.githubusercontent.com/PufferPanel/templates/v2.5/{name}/{name}.json"
const TemplateReadme = "https://raw.githubusercontent.com/PufferPanel/templates/v2.5/{name}/README.md"
