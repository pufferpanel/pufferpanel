...
<template>
  <div class="setting-input-wrapper">
    ...
    <text-field v-else :model-value="modelValue.value" class="setting-input" :disabled="disabled" :label="modelValue.display" :required="modelValue.required" :type="modelValue.type === 'integer' ? 'number' : 'text'" :hint="modelValue.desc" @update:modelValue="onInput($event)" />
  </div>
</template>
