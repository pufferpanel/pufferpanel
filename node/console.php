			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-main" id="server_info">
						<textarea id="live_console" disabled="disabled"><?php echo $core->framework->files->last_lines($core->framework->server->nodeData('server_dir').$core->framework->server->getData('ftp_user').'/server/server.log', 500); ?></textarea>
