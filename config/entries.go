...
var WebHost = asString("web.host", "0.0.0.0:8008")
...
var MasterUrl = asString("panel.settings.masterUrl", "http://localhost:8008")
...
var AuthUrl = asString("daemon.auth.url", "http://localhost:8008")
