...
VALUES
	(1, '37d8949d-5da2-4390-a28f-27ac1babc4da', 'minecraft', 'Minecraft', 'Minecraft is a game about breaking and placing blocks. At first, people built structures to protect against nocturnal monsters, but as the game grew players worked together to create wonderful, imaginative things. This version of the plugin is ment for versions of the game <strong>greater than 1.7.0</strong>.', '-Xms${memory}M -server -jar ${jar} --nojline', '{\"jar\":{\"name\":\"Server Jar Name\",\"description\":\"The name of the server jar file to use when booting the server.\",\"required\":true,\"editable\":true,\"default\":\"server.jar\"},\"build_params\":{\"name\":\"Build Parameters\", \"description\":\"The build parameters to use when creating this server. Please see the documentation <a href=\\\"http://www.pufferpanel.com/docs/adding-a-new-minecraft-server#build-parameters\\\" target=\\\"_blank\\\">located here</a> for how to do this.\",\"required\":false,\"editable\":false,\"default\":\"\"}}'),
	(2, 'a98d5464-7166-4459-88e7-dfad9be96389', 'minecraft-pre', 'MC Pre 1.7', 'Feeling nostalgic? Tired of eating food and all the newfangled whiz-bangs that have been added? Use this option for versions of Minecraft before 1.7 and return to a simpler time.', '-Xms${memory}M -server -jar ${jar}', '{\"jar\":{\"name\":\"Jar\",\"description\":\"\",\"required\":true,\"editable\":true,\"default\":\"server.jar\"},\"build_params\":{\"name\":\"build_params\",\"description\":\"\",\"required\":true,\"editable\":true,\"default\":\"-v 1.6.4\"}}'),
