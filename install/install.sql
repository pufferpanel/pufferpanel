...
VALUES
	...
	(6, '145dc1c0-896c-4e56-964a-b2db68d1ef0d', 'pocketmine', 'Pocketmine-MP', 'Server software for Minecraft: Pocket Edition Put no limits to your imagination. Control all aspects of gameplay. Play on multiple worlds, for free.', '{"jar":{"name":"jar","description":"","required":true,"editable":false,"default":"QuietPufferMine.jar"}}');
