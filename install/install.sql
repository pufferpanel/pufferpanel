...
VALUES
	(1, '37d8949d-5da2-4390-a28f-27ac1babc4da', 'minecraft', 'Minecraft', 'Minecraft is a game about breaking and placing blocks. At first, people built structures to protect against nocturnal monsters, but as the game grew players worked together to create wonderful, imaginative things. This version of the plugin is ment for versions of the game <strong>greater than 1.7.0</strong>.', '-Xms${memory}M -Xmx${memory}M -server -jar ${jar}', '{\"jar\":{\"name\":\"Server Jar Name\",\"description\":\"The name of the server jar file to use when booting the server.\",\"required\":true,\"editable\":true,\"default\":\"server.jar\"},\"build_params\":{\"name\":\"Build Parameters\", \"description\":\"The build parameters to use when creating this server. Please see the documentation <a href=\\\"http://www.pufferpanel.com/docs/adding-a-new-minecraft-server#build-parameters\\\" target=\\\"_blank\\\">located here</a> for how to do this.\",\"required\":false,\"editable\":false,\"default\":\"\"}}'),
	(2, 'a98d5464-7166-4459-88e7-dfad9be96389', 'minecraft-pre', 'Minecraft (pre-1.7)', 'Feeling nostalgic? Tired of eating food and all the newfangled whiz-bangs that have been added? Use this option for versions of Minecraft before 1.7 and return to a simpler time.', '-Xms${memory}M -Xmx${memory}M -server -jar ${jar} -nogui', '{\"jar\":{\"name\":\"Jar\",\"description\":\"\",\"required\":true,\"editable\":true,\"default\":\"server.jar\"},\"build_params\":{\"name\":\"build_params\",\"description\":\"\",\"required\":true,\"editable\":true,\"default\":\"-v 1.6.4\"}}'),
	(3, '64a8fe48-0b69-4e8a-96c4-14c60309c6c1', 'bungeecord', 'BungeeCord', 'For a long time, Minecraft server owners have had a dream that encompasses a free, easy, and reliable way to connect multiple Minecraft servers together. BungeeCord is the answer to said dream. Whether you are a small server wishing to string multiple game-modes together, or the owner of the ShotBow Network, BungeeCord is the ideal solution for you. With the help of BungeeCord, you will be able to unlock your community\'s full potential.', '-Xms${memory}M -Xmx${memory}M -server -jar ${jar}', '{\"jar\":{\"name\":\"BungeeCord Jar Name\",\"description\":\"The name of the BungeeCord jar file to use when booting the server.\",\"required\":true,\"editable\":true,\"default\":\"BungeeCord.jar\"},\"build_params\":{\"name\":\"Build Parameters\", \"description\":\"The build parameters to use when creating this server. Please see the documentation <a href=\\\"http://www.pufferpanel.com/docs/adding-a-new-bungeecord-server#build-parameters\\\" target=\\\"_blank\\\">located here</a> for how to do this.\",\"required\":false,\"editable\":false,\"default\":\"\"}}'),
	(4, '79f128d5-f43b-46e2-b190-9a4cd15f9594', 'srcds', 'SRCDS', 'SRCDS is for Source Dedicated Servers.', '-game ${game} -console +map ${map} -maxplayers ${players} -norestart', '{\"players\":{\"name\":\"Maximum Players\",\"description\":\"The maximum number of players (including bots) that can access a server at once.\",\"required\":true,\"editable\":false,\"default\":\"20\"},\"map\":{\"name\":\"Map\",\"description\":\"The default map to use in a rotation.\",\"required\":false,\"editable\":true,\"default\":\"\"},\"game\":{\"name\": \"SRCDS Game\", \"description\":\"The game type to be used for this server. Please see the full list <a href=\\\"http://forums.srcds.com/viewtopic/12473\\\" target=\\\"_blank\\\">located here</a>\", \"required\": true, \"editable\": false, \"default\":\"\"},\"build_params\":{\"name\":\"SRCDS Application ID\", \"description\":\"The ID corresponding to the application that should be installed on this server. Please see the full list of IDs <a href=\\\"https://developer.valvesoftware.com/wiki/Dedicated_Servers_List\\\" target=\\\"_blank\\\">located here</a>.\",\"required\":true,\"editable\":false,\"default\":\"\"}}'),
